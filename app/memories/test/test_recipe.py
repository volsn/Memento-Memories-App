...
RECIPES_URL = reverse('memories:memories-list')


def image_upload_url(recipe_id):
    """Return URL for memories image upload"""
    return reverse('memories:memories-upload-image', args=(recipe_id,))


def detail_url(recipe_id):
    """Return memories detail URL"""
    return reverse('memories:memories-detail', args=(recipe_id,))
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        """Test creating a memories with tags"""
    ...
    def test_partial_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user, title='Chicken Kari Masala')
        recipe.tags.add(sample_tag(user=self.user))
    ...
    def test_full_update_recipe(self):
        """Test updating a memories with put"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {
            'title': 'Spaghetti',
